...
public class AndroidWiFiTCPServer extends TCPServer {
    ...
    public AndroidWiFiTCPServer(InetAddress address, PublishRelay<Request> tcpServerRequestRelay) throws IOException {
        super(address, tcpServerRequestRelay);
    }

    public static AndroidWiFiTCPServer build(Context androidContext, PublishRelay<Request> tcpServerRequestRelay) throws IOException {
        /**
        ...
        // Start the server
        return new AndroidWiFiTCPServer(deviceIpAddress, tcpServerRequestRelay);
    }
}
